import os, cv2, math, numpy as np, sys, time
...
directory = "C:\\Users\\escam\\Pictures\\imagery\\tiffs_dive\\structure\\images"
files = os.listdir(directory)
filepaths = [os.path.join(directory,i) for i in files]
#print(filepaths)
#print(directory)
os.mkdir("C:\\Users\\escam\\Pictures\\imagery\\tiffs_dive\\structure\\dehazed")
for i in filepaths:
    img = cv2.imread(i)
    try:
        img.shape[2] == 3
    ...
    cv2.imwrite("C:\\Users\\escam\\Pictures\\imagery\\tiffs_dive\\structure\\dehazed\\"+str(c)+".png", out)
    
    c+=1
    
    print("Processed : C:\\Users\\escam\\Pictures\\imagery\\tiffs_dive\\structure\\dehazed\\"+str(c)+".png")
